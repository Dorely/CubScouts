...
Print this page in color and cut along the table borders. The letters are deliberately out of chronological order; do not write dates on the fronts. Every flag is placed in the same 3:2 print area so the cards print at equal sizes.
